...
$(document).ready(function () {
    ...
    $('#parent-submit').on('click', function (event) {
        ...
        $('#' + section_id).find('form input, form select,form textarea').each(
          ...
          var myClass = $this.find("input[name='class']").val();
          var city = $this.find("input[name='inlineRadio1']:checked").val();
          var studentOfYola = $this.find("input[name='inlineRadio2']:checked").val();

          var channels = "";
          var leaflets = $this.find("input[name='other']").val();
          ...
          if (name == "" || email == "" || phone == "" || address == "" || company == "" || position == "" || city == "" || studentOfYola == "" || myClass == "") {
              showAlert('danger', 'Hãy kiểm tra lại thông tin!!!');
             ...
             $.ajax({
                 ...
                 error: function() {
                     console.log("Something wrong. Contact to us !!!");
                 }
             });
          }
    ...
    $('#student-submit').on('click', function (event) {
        ...
        $('#' + section_id).find('form input, form select,form textarea').each(
         ...
         if (name == "" || email == "" || phone == "" || address == "" || studentOfYola == "" || school == "" || birthday == "") {
             showAlert('danger', 'Hãy kiểm tra lại thông tin!!!');
         } else if (!isValidEmailAddress(email)) {
             showAlert('danger', 'Email không hợp lệ!!!');
         } else {
